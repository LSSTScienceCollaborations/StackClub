...
.. list-table::
   ...
   * - **Exploring a Data Repo**
     ...
     - `Phil Marshall <https://github.com/LSSTScienceCollaborations/StackClub/issues/new?body=@drphilmarshall>`_ and `Rob Morgan <https://github.com/LSSTScienceCollaborations/StackClub/issues/new?body=@rmorgan10>`_
